 ...
 * with intertwined serif initials. F sits higher-left, G sits lower-right,
 * and they overlap through the center creating an interlocked emblem.
 *
 * Uses SVG <text> with Cormorant Garamond for reliable, readable letters
 * inside a decorative Baroque-style oval frame.
 */
...
/**
 * Letter layer: F and G interlocked.
 * F sits higher and to the left; G sits lower and to the right.
 * They overlap through the center, creating an intertwined monogram.
 */
export const MONOGRAM_LETTERS = `
  <g fill="currentColor">
    <!-- F (behind, higher-left) -->
    <text x="72" y="150" font-family="'Cormorant Garamond', Georgia, serif" font-size="105" font-weight="600" text-anchor="middle" opacity="0.85">F</text>
    <!-- G (front, lower-right, overlapping the F) -->
    <text x="128" y="185" font-family="'Cormorant Garamond', Georgia, serif" font-size="105" font-weight="600" text-anchor="middle">G</text>
  </g>`
